...
public class ControladorSorteio {
	...
	public boolean cadastrarSorteio(int codigoSorteio, TipoSorteio tipo, String premio, double valorBilhete, double valorParaArrecadar) {
	...
	public boolean cadastrarBilhete(int codigoSorteio, int numero, Vendedor vendedor, Comprador comprador, FormaDePagamento formaPagamento) {
